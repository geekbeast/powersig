...
def build_chebychev_dataset(
    ...
    """
    Build a dataset where each dimension consists of Chebyshev nodes with 
    dimension-specific offsets (d * timestamp added to the index).
    ...
    Returns:
        ...
        containing the next Chebyshev node for each dimension
    """
    ...
    # Generate Chebyshev nodes for each dimension with dimension-specific offsets
    for i in range(num_samples):
        for d in range(dimensions):
            ...
            # Fill this sample for this dimension
            data[i, :, d] = chebychev_nodes
    
    # Generate y tensor with the next Chebyshev node for each dimension
